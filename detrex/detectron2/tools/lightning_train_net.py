...
# We have confirmed that training and validation detectron2_run correctly and produce correct results
...
class TrainingModule(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # This ideally belongs in setup, but setup seems to detectron2_run before processes are spawned
