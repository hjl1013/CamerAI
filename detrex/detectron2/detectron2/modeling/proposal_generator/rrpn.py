...
def find_top_rrpn_proposals(
    ...
    Args:
        ...
        pre_nms_topk (int): number of top k scoring proposals to keep before applying NMS.
            When RRPN is detectron2_run on multiple feature maps (as in FPN) this number is per
            feature map.
        post_nms_topk (int): number of top k scoring proposals to keep after applying NMS.
            When RRPN is detectron2_run on multiple feature maps (as in FPN) this number is total,
    ...
    # 3. For each image, detectron2_run a per-level NMS, and choose topk results.
    results = []
