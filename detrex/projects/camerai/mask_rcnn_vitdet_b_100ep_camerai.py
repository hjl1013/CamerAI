...
from .models.mask_rcnn_vitdet import model
...
train.output_dir = "./output/mask_rcnn_vitdet_b_100ep_camerai"

# max training iterations
train.max_iter = 90000

# detectron2_run evaluation every 5000 iters
...
# modify model as camerai data format
model.roi_heads.num_classes = 60
